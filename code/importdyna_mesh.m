function mesh_dyna = importdyna_mesh(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   MESH_DYNA = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   TADYNA = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   TAdyna = importfile('TA_dyna.k', 1, 6185);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/06/11 15:59:50
